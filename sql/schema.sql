...
-- ------------------------------------------------------------
-- THEME tables (colours, fonts, sizes for every page)
-- One row in theme_settings = one CSS custom property, served by
-- /theme.css.php and used by assets/css/style.css as var(--key).
-- Edited in Admin -> Appearance -> Theme Settings.
-- ------------------------------------------------------------
...
INSERT INTO rsetup (sortfld1) VALUES ('');
